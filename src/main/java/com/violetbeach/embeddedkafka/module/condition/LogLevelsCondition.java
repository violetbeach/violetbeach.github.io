...
package com.violetbeach.embeddedkafka.module.condition;
...
import static com.violetbeach.embeddedkafka.module.utils.JUnitUtils.*;
...
public class LogLevelsCondition
	...
	public void beforeAll(ExtensionContext context) {
		...
		if (logLevels != null) {
			store.put(STORE_CONTAINER_KEY, adjustLogLevels(context.getDisplayName(),
	...
	public void afterEach(ExtensionContext context) {
		...
		if (container != null) {
			LogLevels logLevels = store.get(STORE_ANNOTATION_KEY, LogLevels.class);
			if (logLevels != null) {
				revertLevels(context.getDisplayName(), container);
